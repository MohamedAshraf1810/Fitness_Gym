  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-black myNav" id="myHeader" >
    ...
    <section class="section_8">
      <div class="S8Container">
        ...
        <div class="s8ConDiv1" id="classesTable">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 s9BootConDiv1">
                    <div class="s9BootConD1Div1">
                      ...
                      <ul>
                        ...
                        <button><a class="Suppbtn" href="login.php" id ="GetStarted120">Get Started</a></button>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 s9BootConDiv1">
                    <div class="s9BootConD1Div1">
                      ...
                      <ul>
                        ...
                        <li class="unCheckedMark"><span class="canc">3 Month </span><span class="canc">Free personal training</span></li>
                        <button><a class="Suppbtn" href="login.php" id="GetStarted180">Get Started</a></button>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 s9BootConDiv1">
                    <div class="s9BootConD1Div1">
                      ...
                      <ul>
                        ...
                        <button><a class="Suppbtn" href="login.php" id="GetStarted250">Get Started</a></button>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <div class="s10ConDiv1">
          <div class="s10ConD1Div1">
            ...
            <div>
              ...
              <button ><a class="Suppbtn" href="Signup.php">Sign up right now!</a></button>
            </div>
          </div>
        </div>
